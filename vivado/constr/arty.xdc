...
set_input_delay -clock [get_clocks sys_clk_pin] 0.000 [get_ports resetn]

set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_r[0]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_r[1]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_r[2]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_r[3]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_g[0]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_g[1]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_g[2]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_g[3]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_b[0]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_b[1]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_b[2]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports {vga_b[3]}]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports vga_hsync]
set_output_delay -clock [get_clocks clk_display_clk_wiz] 0.000 [get_ports vga_vsync]
set_output_delay -clock [get_clocks clk_pll_i] 0.000 [get_ports ddr3_reset_n]
