...
#
# rtl.tcl: Tcl script for re-creating project 'rtl'
#
# Generated by Vivado on Thu Apr 27 21:42:59 CST 2023
...
#
# 1. This project restoration tcl script (rtl.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../[file normalize "$origin_dir/core/solution1/impl/ip"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/rtl"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/core/solution1/impl/ip"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: trinity_0, and set properties
  set trinity_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:trinity:1.0 trinity_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net trinity_0_m_axis_video [get_bd_intf_pins trinity_0/m_axis_video] [get_bd_intf_pins v_frmbuf_wr_0/s_axis_video]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins trinity_0/ap_rst_n] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins trinity_0/ap_start] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins trinity_0/ap_clk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"3,-340",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 5 -x 1790 -y 100 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 6 -x 2270 -y 150 -defaultsOSRD
preplace inst axi_interconnect_1 -pg 1 -lvl 4 -x 1320 -y 160 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 210 -y 510 -defaultsOSRD
preplace inst v_frmbuf_wr_0 -pg 1 -lvl 3 -x 960 -y 390 -defaultsOSRD
preplace inst trinity_0 -pg 1 -lvl 2 -x 570 -y 380 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 210 -y 370 -defaultsOSRD
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 5 400 480 760 280 1170 280 NJ 280 2120
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 6 30 310 390 470 740 200 1150 40 1470 200 2110
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 6 20 290 NJ 290 750J 300 NJ 300 NJ 300 2100
preplace netloc xlconstant_0_dout 1 1 1 NJ 370
preplace netloc axi_interconnect_0_M00_AXI 1 2 5 770 290 NJ 290 NJ 290 2110J 300 2420
preplace netloc axi_interconnect_1_M00_AXI 1 4 1 1480 60n
preplace netloc v_frmbuf_wr_0_m_axi_mm_video 1 3 1 1160 100n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 5 1 N 60
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 5 1 N 80
preplace netloc trinity_0_m_axis_video 1 2 1 N 380
levelinfo -pg 1 0 210 570 960 1320 1790 2270 2440
pagesize -pg 1 -db -bbox -sgen 0 0 2440 610
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/rtl/rtl.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
